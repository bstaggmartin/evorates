...
#include "stanExports_univar_corateBM.h"

RCPP_MODULE(stan_fit4univar_corateBM_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_univar_corateBM")

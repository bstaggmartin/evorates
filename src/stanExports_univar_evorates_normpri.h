...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_univar_evorates_normpri");
    reader.add_event(288, 286, "end", "model_univar_evorates_normpri");
    return reader;
}
...
class model_univar_evorates_normpri
  : public stan::model::model_base_crtp<model_univar_evorates_normpri> {
private:
        int n;
        int e;
        matrix_d eV;
...
public:
    ...
    void write_array(RNG& base_rng__,
        ...
        try {
            ...
            stan::math::assign(prior, normal_log(R0, R0_prior_mu, R0_prior_sig));
            ...
            if (as_bool(logical_negation(constr_Rmu))) {
                ...
                stan::math::assign(prior, (prior + normal_log(get_base1(Rmu, 1, "Rmu", 1), Rmu_prior_mu, Rmu_prior_sig)));
            }
    ...
    std::string model_name() const {
        return "model_univar_evorates_normpri";
    }
...
typedef model_univar_evorates_normpri_namespace::model_univar_evorates_normpri stan_model;
#ifndef USING_R

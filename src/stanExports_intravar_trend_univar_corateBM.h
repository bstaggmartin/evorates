...
namespace model_intravar_trend_univar_corateBM_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_intravar_trend_univar_corateBM");
    reader.add_event(91, 89, "end", "model_intravar_trend_univar_corateBM");
    return reader;
}
#include <stan_meta_header.hpp>
class model_intravar_trend_univar_corateBM : public prob_grad {
private:
        int obs;
        int n;
        int n_e;
        ...
        vector_d T_midpts;
public:
    model_intravar_trend_univar_corateBM(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_intravar_trend_univar_corateBM_namespace::model_intravar_trend_univar_corateBM";
        ...
        try {
            ...
            validate_non_negative_index("X_obs", "obs", obs);
            context__.validate_dims("data initialization", "X_obs", "vector_d", context__.to_vec(obs));
            X_obs = Eigen::Matrix<double, Eigen::Dynamic, 1>(obs);
            vals_r__ = context__.vals_r("X_obs");
            pos__ = 0;
            size_t X_obs_j_1_max__ = obs;
            for (size_t j_1__ = 0; j_1__ < X_obs_j_1_max__; ++j_1__) {
                X_obs(j_1__) = vals_r__[pos__++];
            }
            ...
            context__.validate_dims("data initialization", "X_prior", "double", context__.to_vec());
            X_prior = double(0);
            vals_r__ = context__.vals_r("X_prior");
            pos__ = 0;
            X_prior = vals_r__[pos__++];
            current_statement_begin__ = 19;
            context__.validate_dims("data initialization", "Xsig2_prior", "double", context__.to_vec());
            Xsig2_prior = double(0);
            vals_r__ = context__.vals_r("Xsig2_prior");
            pos__ = 0;
            Xsig2_prior = vals_r__[pos__++];
            ...
            validate_non_negative_index("T_midpts", "n_e", n_e);
            T_midpts = Eigen::Matrix<double, Eigen::Dynamic, 1>(n_e);
    ...
    ~model_intravar_trend_univar_corateBM() { }
    void transform_inits(const stan::io::var_context& context__,
        ...
        current_statement_begin__ = 36;
        if (!(context__.contains_r("Xsig2")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable Xsig2 missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("Xsig2");
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "Xsig2", "double", context__.to_vec());
        double Xsig2(0);
        Xsig2 = vals_r__[pos__++];
        try {
            writer__.scalar_lb_unconstrain(0, Xsig2);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable Xsig2: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 37;
        ...
        current_statement_begin__ = 38;
        if (!(context__.contains_r("Rmu")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable Rmu missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("Rmu");
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "Rmu", "double", context__.to_vec());
        double Rmu(0);
        Rmu = vals_r__[pos__++];
        try {
            writer__.scalar_unconstrain(Rmu);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable Rmu: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 39;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            current_statement_begin__ = 36;
            local_scalar_t__ Xsig2;
            (void) Xsig2;  // dummy to suppress unused var warning
            if (jacobian__)
                Xsig2 = in__.scalar_lb_constrain(0, lp__);
            else
                Xsig2 = in__.scalar_lb_constrain(0);
            current_statement_begin__ = 37;
            local_scalar_t__ R0;
            ...
            (void) Rmu;  // dummy to suppress unused var warning
            if (jacobian__)
                Rmu = in__.scalar_constrain(lp__);
            else
                Rmu = in__.scalar_constrain();
            current_statement_begin__ = 39;
            ...
            stan::math::assign(R, add(add(R0, multiply(Rmu, T_midpts)), multiply(multiply(stan::math::sqrt(Rsig2), chol_eV), raw_R)));
            ...
            lp_accum__.add(cauchy_log<propto__>(X, 0, X_prior));
            current_statement_begin__ = 60;
            lp_accum__.add(cauchy_log<propto__>(Xsig2, 0, Xsig2_prior));
            current_statement_begin__ = 61;
            lp_accum__.add(cauchy_log<propto__>(R0, 0, R0_prior));
            current_statement_begin__ = 62;
            lp_accum__.add(cauchy_log<propto__>(Rmu, 0, Rmu_prior));
            current_statement_begin__ = 63;
            lp_accum__.add(cauchy_log<propto__>(Rsig2, 0, Rsig2_prior));
            current_statement_begin__ = 64;
            lp_accum__.add(cauchy_log<propto__>(X0, 0, X0_prior));
            ...
            for (int i = 1; i <= n; ++i) {
                ...
                lp_accum__.add(normal_log<propto__>(segment(X_obs, counter, get_base1(n_obs, i, "n_obs", 1)), get_base1(X, i, "X", 1), stan::math::sqrt(Xsig2)));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_intravar_trend_univar_corateBM_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        double Xsig2 = in__.scalar_lb_constrain(0);
        vars__.push_back(Xsig2);
        double R0 = in__.scalar_constrain();
        vars__.push_back(R0);
        double Rmu = in__.scalar_constrain();
        vars__.push_back(Rmu);
    ...
    static std::string model_name() {
        return "model_intravar_trend_univar_corateBM";
    }
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        param_name_stream__.str(std::string());
        param_name_stream__ << "Xsig2";
        param_names__.push_back(param_name_stream__.str());
        param_name_stream__.str(std::string());
        param_name_stream__ << "R0";
        param_names__.push_back(param_name_stream__.str());
        param_name_stream__.str(std::string());
        param_name_stream__ << "Rmu";
        param_names__.push_back(param_name_stream__.str());
        param_name_stream__.str(std::string());
...
typedef model_intravar_trend_univar_corateBM_namespace::model_intravar_trend_univar_corateBM stan_model;
#endif

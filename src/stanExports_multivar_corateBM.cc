...
#include "stanExports_multivar_corateBM.h"

RCPP_MODULE(stan_fit4multivar_corateBM_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_multivar_corateBM")

...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(294, 292, "end", "model_univar_evorates");
    return reader;
}
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            context__.validate_dims("data initialization", "n_0tip", "int", context__.to_vec());
            n_0tip = int(0);
            vals_i__ = context__.vals_i("n_0tip");
            pos__ = 0;
            n_0tip = vals_i__[pos__++];
            current_statement_begin__ = 69;
            validate_non_negative_index("which_0tip", "n_0tip", n_0tip);
            context__.validate_dims("data initialization", "which_0tip", "int", context__.to_vec(n_0tip));
            which_0tip = std::vector<int>(n_0tip, int(0));
            vals_i__ = context__.vals_i("which_0tip");
            pos__ = 0;
            size_t which_0tip_k_0_max__ = n_0tip;
            for (size_t k_0__ = 0; k_0__ < which_0tip_k_0_max__; ++k_0__) {
                which_0tip[k_0__] = vals_i__[pos__++];
            }
            ...
            has_0tip = int(0);
            stan::math::fill(has_0tip, std::numeric_limits<int>::min());
            ...
            if (as_bool(logical_eq(n_0tip, 0))) {
                current_statement_begin__ = 151;
                stan::math::assign(has_0tip, 0);
            } else {
                current_statement_begin__ = 153;
                stan::math::assign(has_0tip, 1);
            }
        ...
        try {
            ...
            if (as_bool(logical_negation(constr_Rmu))) {
                ...
                if (as_bool(has_0tip)) {
                    ...
                    stan::model::assign(R, 
                                stan::model::cons_list(stan::model::index_multi(which_0tip), stan::model::nil_index_list()), 
                                stan::model::deep_copy(add(stan::model::rvalue(R, stan::model::cons_list(stan::model::index_multi(which_0tip), stan::model::nil_index_list()), "R"), multiply(get_base1(Rmu, 1, "Rmu", 1), stan::model::rvalue(T_1, stan::model::cons_list(stan::model::index_multi(which_0tip), stan::model::nil_index_list()), "T_1")))), 

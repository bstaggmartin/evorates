...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      " (in 'string', line 179, column 2 to column 43)",
                                                      " (in 'string', line 180, column 2 to column 58)",
                                                      " (in 'string', line 181, column 2 to column 60)",
                                                      " (in 'string', line 182, column 2 to column 62)",
                                                      ...
                                                      " (in 'string', line 205, column 3 to column 59)",
                                                      ...
                                                      " (in 'string', line 253, column 3 to line 255, column 38)",
                                                      " (in 'string', line 257, column 6 to column 80)",
                                                      " (in 'string', line 256, column 18 to line 258, column 5)",
                                                      " (in 'string', line 256, column 4 to line 258, column 5)",
                                                      " (in 'string', line 252, column 7 to line 259, column 3)",
                                                      " (in 'string', line 251, column 4 to column 30)",
                                                      " (in 'string', line 250, column 17 to line 252, column 3)",
                                                      " (in 'string', line 250, column 2 to line 259, column 3)",
                                                      " (in 'string', line 262, column 2 to column 54)",
                                                      " (in 'string', line 264, column 4 to column 62)",
                                                      " (in 'string', line 263, column 16 to line 265, column 3)",
                                                      " (in 'string', line 263, column 2 to line 265, column 3)",
                                                      " (in 'string', line 267, column 4 to column 65)",
                                                      " (in 'string', line 268, column 4 to column 78)",
                                                      " (in 'string', line 266, column 19 to line 269, column 3)",
                                                      " (in 'string', line 266, column 2 to line 269, column 3)",
                                                      " (in 'string', line 271, column 4 to column 63)",
                                                      " (in 'string', line 270, column 17 to line 272, column 3)",
                                                      " (in 'string', line 270, column 2 to line 272, column 3)",
                                                      " (in 'string', line 238, column 3 to column 24)",
                                                      " (in 'string', line 237, column 18 to line 239, column 2)",
                                                      " (in 'string', line 237, column 1 to line 239, column 2)",
                                                      " (in 'string', line 243, column 1 to column 31)",
                                                      ...
                                                      " (in 'string', line 182, column 44 to column 60)",
...
class model_univar_evorates final : public model_base_crtp<model_univar_evorates> {
private:
  int n;
  int e;
...
public:
  ...
  inline std::string model_name() const final { return "model_univar_evorates"; }
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_univar_evorates_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      if (jacobian__) {
        current_statement__ = 1;
        std_R0 = stan::math::lub_constrain(std_R0, (-stan::math::pi() / 2),
                   (stan::math::pi() / 2), lp__);
      } else {
        current_statement__ = 1;
        std_R0 = stan::math::lub_constrain(std_R0, (-stan::math::pi() / 2),
      ...
      for (int sym1__ = 1; sym1__ <= std_Rmu_1dim__; ++sym1__) {
        ...
        if (jacobian__) {
          current_statement__ = 4;
          assign(std_Rmu, cons_list(index_uni(sym1__), nil_index_list()),
            stan::math::lub_constrain(std_Rmu[(sym1__ - 1)],
              (-stan::math::pi() / 2), (stan::math::pi() / 2), lp__),
            "assigning variable std_Rmu");
        } else {
          current_statement__ = 4;
          assign(std_Rmu, cons_list(index_uni(sym1__), nil_index_list()),
            stan::math::lub_constrain(std_Rmu[(sym1__ - 1)],
              (-stan::math::pi() / 2), (stan::math::pi() / 2)),
            "assigning variable std_Rmu");
        }}
      ...
      R0 = (R0_prior_mu + (R0_prior_sig * stan::math::tan(std_R0)));
      ...
      if (logical_negation(constr_Rmu)) {
        ...
        assign(Rmu, cons_list(index_uni(1), nil_index_list()),
          (Rmu_prior_mu +
            (Rmu_prior_sig * stan::math::tan(std_Rmu[(1 - 1)]))),
...
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      prior = cauchy_lpdf<false>(R0, R0_prior_mu, R0_prior_sig);
      ...
      if (logical_negation(constr_Rmu)) {
        ...
        prior = (prior +
                  cauchy_lpdf<false>(Rmu[(1 - 1)], Rmu_prior_mu,
                    Rmu_prior_sig));
      } 
  ...
  inline void transform_inits_impl(const stan::io::var_context& context__,
    ...
    try {
      ...
      double std_R0_free__;
      std_R0_free__ = std::numeric_limits<double>::quiet_NaN();
      
      current_statement__ = 1;
      std_R0_free__ = stan::math::lub_free(std_R0, (-stan::math::pi() / 2),
                        (stan::math::pi() / 2));
      std::vector<double> std_Ysig2;
      std_Ysig2 = std::vector<double>(std_Ysig2_1dim__, std::numeric_limits<double>::quiet_NaN());
      ...
      assign(std_Rmu, nil_index_list(), context__.vals_r("std_Rmu"),
        "assigning variable std_Rmu");
      std::vector<double> std_Rmu_free__;
      std_Rmu_free__ = std::vector<double>(std_Rmu_1dim__, std::numeric_limits<double>::quiet_NaN());
      
      current_statement__ = 4;
      for (int sym1__ = 1; sym1__ <= std_Rmu_1dim__; ++sym1__) {
        current_statement__ = 4;
        assign(std_Rmu_free__,
          cons_list(index_uni(sym1__), nil_index_list()),
          stan::math::lub_free(std_Rmu[(sym1__ - 1)],
            (-stan::math::pi() / 2), (stan::math::pi() / 2)),
          "assigning variable std_Rmu_free__");}
      Eigen::Matrix<double, -1, 1> raw_R;
      raw_R = Eigen::Matrix<double, -1, 1>(raw_R_1dim__);
      stan::math::fill(raw_R, std::numeric_limits<double>::quiet_NaN());
...
using stan_model = model_univar_evorates_namespace::model_univar_evorates;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_univar_evorates_namespace::profiles__;
}
#endif
#endif

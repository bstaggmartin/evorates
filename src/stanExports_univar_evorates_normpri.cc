...
#include "stanExports_univar_evorates_normpri.h"

RCPP_MODULE(stan_fit4univar_evorates_normpri_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_univar_evorates_normpri")
